...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'chef', 'manager', name='userrole'), nullable=True),
    ...
    sa.Column('alert_type', sa.Enum('ingredient_low', 'usage_suspicious', name='alerttype'), nullable=False),
    sa.Column('is_read', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('related_ingredient_id', sa.Integer(), nullable=True),
    sa.Column('related_report_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['related_ingredient_id'], ['ingredients.id'], ),
    sa.ForeignKeyConstraint(['related_report_id'], ['monthly_reports.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_alerts_id'), 'alerts', ['id'], unique=False)
    op.create_table('ingredient_deliveries',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_ingredient_deliveries_id'), 'ingredient_deliveries', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('meals')
    op.drop_index(op.f('ix_ingredient_deliveries_id'), table_name='ingredient_deliveries')
