...
class ConnectionManager:
    ...
    async def broadcast_inventory_update(self, ingredient_id: int, ingredient_name: str, quantity: float):
        message = json.dumps({
    ...
    async def broadcast_alert(self, alert_type: str, message: str, related_id: Optional[int] = None):
        alert_data = {
            "type": "alert",
            "data": {
    ...
    async def broadcast_low_stock_alert(self, ingredient_id: int, ingredient_name: str, quantity: float, min_quantity: float):
        message = json.dumps({
